...
{
    [ExposeClass(Context = ConstantsCore.Configuration, ExposedType = typeof(Broker), Name = "SqlServerManagerConfiguration", LifeCycle = IocScopeEnum.Singleton)]
    public class SqlServerManagerConfiguration : SqlManagerConfiguration
    {
